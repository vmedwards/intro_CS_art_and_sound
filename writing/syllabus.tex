...
\item \textbf{Class Discord Server}: \url{https://discord.gg/ryvtgt6S}
...
The exam will take place on Nov 20, 2025 in CHE 103 during your assigned class section. 
...
\begin{itemize}
\item Week 0: Introductions \& Computer Setup
\item Week 1: Functions, Symbol Tables, and Generating Data
\item Week 2: Loops, Conditionals, and Extracting Data
\item Week 3: Lists, More Conditionals, and Manipulating Data
\item Week 4: More Lists, Copy, and Population Variability
\item Week 5: Modular Design, Dictionaries, and Building Simulations
\item Week 6: More Modular Design and Optimization with Simulation
\item Week 7: Basics of Object Oriented Design, Final Project Details, and Faculty Retreat (No lab and no class on Thursday)
\item Week 8: TBD, and work on final project
\item Week 9: Guest Lectures and work on final project
\item Week 10: Final Project Presentations, Review Session during lab, and Final Exam 
\end{itemize}
