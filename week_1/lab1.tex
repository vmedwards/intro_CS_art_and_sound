...
Python is a powerful interpreted language that can do many different things. Last fall we learned the same concepts you will this spring but did assignments that mainpulated and created data. This spring we will focus on art and sound for our assignments.
...
\begin{itemize}
\item \texttt{forawrd(x)} - move forward \texttt{x} pixels
...
You cannot write code in Microsoft or Google Docs. Instead you write code in a texteditor that removes fancy fonts and other formatting features.
